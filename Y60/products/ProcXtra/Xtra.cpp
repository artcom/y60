 ...
 ****************************************************************************/
BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CProc, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CProc, IMoaRegister, XTRA_VERSION_NUMBER)
		/*
		 * ---> insert additional interface(s) -->
		 */
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CProcScript, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CProcScript, IMoaMmXScript, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(CProcScript, IMoaInitFromDict, XTRA_VERSION_NUMBER)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CProcScript, IMoaNotificationClient, XTRA_VERSION_NUMBER)
		#endif
		/*
		 * ---> insert additional interface(s) -->
		 */
