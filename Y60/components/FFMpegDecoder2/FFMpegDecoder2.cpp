...
namespace y60 {
    ...
    const unsigned FFMpegDecoder2::FRAME_CACHE_SIZE = 32;//8;
...
//            AC_DEBUG << "---- FFMpegDecoder2::readAudio: getPacket()";
    ...
    void FFMpegDecoder2::setupVideo(const std::string & theFilename) {
        ...
        TextureInternalFormat myTargetPixelFormat = myRasterPixelFormat;
...
//        myRasterPixelFormat = TEXTURE_IFMT_ALPHA;
