...
function getAvgDirectionVector( theEventQueue ) {

    var myAvgDirection = new Vector2f( 0, 0 );
    for (var i = 0; i < theEventQueue.length-1; i++) {
        var myFirstPos = getMousePos( theEventQueue[i].raw_position );
        var mySecondPos = getMousePos( theEventQueue[i+1].raw_position );
