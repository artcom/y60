...
//
//=============================================================================
#ifndef INCL_DSOUNDMESSAGES
#define INCL_DSOUNDMESSAGES
...
namespace AudioBase {
    ...
    class DirectSoundException : public asl::Exception {
    public:
        DirectSoundException(const std::string & what, const std::string & where) : asl::Exception(what, where, "DirectSoundException") {}
        DirectSoundException(HRESULT error, const std::string & where)
        {
            set(DSoundMessages::ErrorMessage(error), where, "DirectSoundException");
        }
    protected:
        DirectSoundException(const std::string & what, const std::string & where, const char* name) : asl::Exception(what, where, name) {}
    };
}

#define DSERRORHANDLER(x) if (FAILED(x)) { throw DirectSoundException(x, PLUS_FILE_LINE); }
