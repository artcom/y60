...
IF(SDL_LIBRARY_TEMP_D)
  ...
  SET(SDL_FOUND "YES")
ENDIF(SDL_LIBRARY_TEMP_D)

#MESSAGE("SDL_LIBRARY is ${SDL_LIBRARY}")
#MESSAGE("SDL_LIBRARY_D is ${SDL_LIBRARY_D}")

mark_as_advanced( SDLMAIN_LIBRARY SDLMAIN_LIBRARY_D SDL_INCLUDE_DIR
        SDL_LIBRARY SDL_LIBRARY_D SDL_LIBRARY_TEMP_D )
