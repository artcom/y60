if(WIN32)
    ...
    FIND_PATH(OPENCV_INCLUDE_DIR cxcore.h
    ...
    foreach(SUBLIB ${OPENCV_SUBLIBS})
        ...
        find_library(OPENCV_SUBLIB_${SUBLIB} NAMES ${SUBLIB}  PATH_SUFFIXES lib PATHS "C:/OpenCV2.1")
    ...
    foreach(SUBLIB ${OPENCV_SUBLIBS})
        ...
        find_library(OPENCV_SUBLIB_${SUBLIB}_D NAMES ${SUBLIB}  PATH_SUFFIXES lib PATHS "C:/OpenCV2.1")
