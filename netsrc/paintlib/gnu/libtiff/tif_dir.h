/* $Header: /cvsroot/paintlib/paintlib/gnu/libtiff/tif_dir.h,v 1.2 2002/03/31 13:36:42 uzadow Exp $ */
...
#define	FIELD_SETLONGS	3
	...
	uint32*	td_subifd;
#endif
#ifdef YCBCR_PL_SUPPORT
	float*	td_ycbcrcoeffs;
	uint16	td_ycbcrsubsampling[2];
	uint16	td_ycbcrpositioning;
#endif
#ifdef COLORIMETRY_PL_SUPPORT
	float*	td_whitepoint;
	float*	td_primarychromas;
	float*	td_refblackwhite;
	uint16*	td_transferfunction[3];
#endif
#ifdef CMYK_PL_SUPPORT
	uint16	td_inkset;
	uint16	td_ninks;
