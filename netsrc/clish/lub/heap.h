...
- leakShow [0|1|2]        - provides a dump of the currently allocated blocks of 
...
struct lub_heap_stats_s
{
    ...
    /**
     * Largest free block when the memory usage was at it's highest.
     */
    size_t free_hightide_largest;
    /**
...
typedef enum
{
     ...
     * 4 byte alignment
     */
    LUB_HEAP_ALIGN_4    = 0x00000004,
    /**
     * 8 byte alignment
     */
    LUB_HEAP_ALIGN_8    = 0x00000008,
    /**
     * 16 byte alignment
     */
    LUB_HEAP_ALIGN_16   = 0x00000010,
    /**
     * 32 byte alignment
     */
    LUB_HEAP_ALIGN_32   = 0x00000020,
    /**
     * 64 byte alignment
     */
    LUB_HEAP_ALIGN_64   = 0x00000040,
    /**
     * 128 byte alignment
     */
    LUB_HEAP_ALIGN_128  = 0x00000080,
    /**
     * 256 byte alignment
     */
    LUB_HEAP_ALIGN_256  = 0x00000100,
    /**
     * 512 byte alignment
     */
    LUB_HEAP_ALIGN_512  = 0x00000200,
    /**
     * 1024 byte alignment
     */
    LUB_HEAP_ALIGN_1024  = 0x00000400,
    /**
     * 2048 byte alignment
     */
    LUB_HEAP_ALIGN_2048  = 0x00000800,
    /**
     * 4096 byte alignment
     */
    LUB_HEAP_ALIGN_4096  = 0x00001000,
    /**
     * 8192 byte alignment
     */
    LUB_HEAP_ALIGN_8192  = 0x00002000,
    /**
     * 16384 byte alignment
     */
    LUB_HEAP_ALIGN_16384 = 0x00004000,
    /**
     * 32768 byte alignment
     */
    LUB_HEAP_ALIGN_32768 = 0x00008000
} lub_heap_align_t;
