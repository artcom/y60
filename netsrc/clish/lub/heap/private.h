...
struct lub_heap_tag_s
{
    ...
    unsigned words   : 30; /* number of words in block */
};
...
struct lub_heap_s
{
    ...
    /*
     * This is used to track internal allocations (which should
     * not be monitored otherwise recursive loop can occur)
     */
    ...
    /*
     * pool instance for allocating contexts
     */
    lub_dblockpool_t context_pool;
    /*
...
extern lub_heap_t *lub_heap_list;
...
extern lub_heap_status_t
    lub_heap_post_realloc(
        ...
        char **ptr,
        /*
         * The number of bytes allocated to the client pointer
         */
         size_t size
    );
/*
...
#define lub_heap_block_from_ptr(p) ((lub_heap_block_t*)&((lub_heap_tag_t*)(p))[-1])
