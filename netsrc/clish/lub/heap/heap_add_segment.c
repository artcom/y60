...
/*
 * This tree holds reference to all the segments in the system
 */
lub_bintree_t segment_tree;
...
lub_heap_segment_findnext(const void *address)
{
    ...
    return lub_bintree_findnext(&segment_tree,&key);
}
/*--------------------------------------------------------- */
/*
                     ...
                     size_t      size)
{
    ...
    lub_bintree_insert(&segment_tree,segment);
