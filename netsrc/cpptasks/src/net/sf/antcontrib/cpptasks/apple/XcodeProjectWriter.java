...
public final class XcodeProjectWriter
   ...
   */
  public void writeProject(final File fileName, final CCTask task,
                           final ProjectDef projectDef, final Hashtable targets,
    ...
    while (targetIter.hasNext()) {
      ...
      for (int i = 0; i < sources.length; i++) {
        sourceList.addElement(new SourceEntry(sources[i],
