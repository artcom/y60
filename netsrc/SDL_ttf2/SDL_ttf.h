...
extern DECLSPEC int* TTF_getCurrentGlyphXPositions();
...
/* Convert to Unicode */
extern DECLSPEC Uint16 *LATIN1_to_UNICODE(Uint16 *unicode, const char *text, int len);
extern DECLSPEC Uint16 *UTF8_to_UNICODE(Uint16 *unicode, const char *utf8, int len);
