 ...
 *     CTCPClientScript          <name of the class you defined>
 *
 *     Register        <its file name>
 *     CTCPClient       <name of the class you defined>
 *
 ...
 ****************************************************************************/
BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CIPClient, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CIPClient, IMoaRegister, XTRA_VERSION_NUMBER)
		/*
		 * ---> insert additional interface(s) -->
		 */
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CIPClientScript, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CIPClientScript, IMoaMmXScript, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(CIPClientScript, IMoaInitFromDict, XTRA_VERSION_NUMBER)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CIPClientScript, IMoaNotificationClient, XTRA_VERSION_NUMBER)
		#endif
		/*
		 * ---> insert additional interface(s) -->
		 */
