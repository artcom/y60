...
namespace xpath {
    ...
    int
    parseArgumentList(std::list<Expression*> *arguments, const std::string &instring, int pos) {
    ...
    int
    parsePrimaryExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseUnionExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseUnaryExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseMultExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseAddExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseRelationalExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseEqualityExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseAndExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseOrExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseExpression(Expression **e, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseStep(Path *p, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parseRelativePath(Path *p, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
    ...
    int
    parsePath(Path *p, const std::string &instring, int pos) {
#ifdef DEBUG_PARSER_STATES
