...
/*globals use, Node, Quaternionf, Logger, Scene, print, createUniqueId,
          SunPositioner*/
...
LightManager.prototype.Constructor = function(obj, theScene, theWorld) {
    ...
    function createHeadlight(theLightName) {
        return myHeadLight; // ??? What is myHeadLight?
    }
            ...
            case 'j':
                if (theShiftFlag) {
                    ...
                    if (_myLightCursor < _myLights.length) {
                        _myLights[_myLightCursor].visible = ! _myLights[_myLightCursor].visible;
                       print ('light # ' + _myLights[_myLightCursor].name +
                              ' now visible ' +_myLights[_myLightCursor].visible);
                    }
                }
                break;
            case 'h':
