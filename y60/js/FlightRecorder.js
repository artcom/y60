...
CameraKeyframe.prototype.Constructor = function(obj, theId, theSceneViewer, theCameraNode) {
    ...
    function createNewCameraNode(theId) {
        ...
        _myCameraNode.id   = createUniqueId();
...
GTKFlightRecorder.prototype.Constructor = function(obj, theArguments, theName) {
    ...
    obj.run = function() {
        var myGlade = new Glade("flightrecorder.glade", "mainWindow");
        _myMainWindow = new Window();
        _myMainWindow.resize(1025,660);
...
/*    _myHandler.on_pbInterpolation_toggled = function() {
    ...
    _myHandler.on_open1_activate = function(theMenu) {
        ...
        if (fileExists(myFilename)) {
            ...
            myFlightDom.parseFile(_myFlightIdWidget.text + FILE_EXTENSION);
            ...
            calcDuration();
            print("Loaded flight: " + _myFlightIdWidget.text+ FILE_EXTENSION + " with " + _myKeyframes.length +
    ...
    _myHandler.on_save1_activate = function(theMenu) {
        var myFileChooserDialog = new FileChooserDialog("lade Scene", FileChooserDialog.ACTION_SAVE);
        ...
        if (!_myBlendingStarted) {
            ...
            if (myFrame0 && myFrame1) {
                ...
                if (myFrame0.getNode().position.value == undefined ) {
                    ...
                    _myStartOrientation       = new Vector3f(stringToArray(myFrame0.getNode().orientation));
                } else {
                ...
                if (myFrame1.getNode().position.value == undefined ) {
                    ...
                    _myEndOrientation         = new Vector3f(stringToArray(myFrame1.getNode().orientation));
                } else {
