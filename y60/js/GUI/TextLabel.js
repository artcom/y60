...
TextLabel.prototype.Constructor = function(Public, Protected, theParent, theTextLabelNode, theDepth) {
    ...
    var _myName   = theTextLabelNode.name;
    var _myNode   = theTextLabelNode;
    var _myParent = theParent;

    TextWidget.prototype.Constructor(Public, Protected, theParent, theTextLabelNode, theDepth);
