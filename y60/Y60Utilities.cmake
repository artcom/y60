...
macro(write_scenetest NAME)
  ...
  file(APPEND ${CMAKEFILE} "  COMMAND ${CMAKE_BINARY_DIR}/y60/products/y60/Release/y60 -I \"${CMAKE_BINARY_DIR}/testmodels;${CMAKE_SOURCE_DIR}/y60/js;${CMAKE_BINARY_DIR}/lib/Release;${CMAKE_SOURCE_DIR}/y60/shader\" ${SCRIPT} ${SCENE} ${SHADERLIB} rehearsal offscreen outputimage=${CMAKE_BINARY_DIR}/testmodels/TestImages/${NAME} outputsuffix=${IMGSUFFIX}\n")
  ...
  while(EXISTS ${BASELINEIMG})
    ...
    file(APPEND ${CMAKEFILE} "execute_process(\n")
    file(APPEND ${CMAKEFILE} "  COMMAND ${CMAKE_BINARY_DIR}/y60/products/CompareImage/Release/ac-compare-image --tolerance 0.12 --threshold 30 ${TESTIMG} ${BASELINEIMG}\n")
    file(APPEND ${CMAKEFILE} "  WORKING_DIRECTORY ${TESTMODELDIR}\n")
    file(APPEND ${CMAKEFILE} "  RESULT_VARIABLE rv\n")
    file(APPEND ${CMAKEFILE} ")\n")
