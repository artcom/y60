...
Y60_JSGTK_DECL template<> jsval as_jsval<GdkEvent>(JSContext *cx, GdkEvent* theNative);
Y60_JSGTK_DECL template<> jsval as_jsval<GdkEventKey>(JSContext *cx, GdkEventKey * theNative);
Y60_JSGTK_DECL template<> jsval as_jsval<GdkEventAny>(JSContext *cx, GdkEventAny * theNative);
Y60_JSGTK_DECL template<> jsval as_jsval<GdkEventFocus>(JSContext *cx, GdkEventFocus * theNative);
Y60_JSGTK_DECL template<> jsval as_jsval<GdkEventButton>(JSContext *cx, GdkEventButton * theNative);
Y60_JSGTK_DECL template<> jsval as_jsval<GdkEventCrossing>(JSContext *cx, GdkEventCrossing * theNative);
Y60_JSGTK_DECL template<> jsval as_jsval<GdkEventMotion>(JSContext *cx, GdkEventMotion * theNative);
