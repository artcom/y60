...
Y60_MODELLING_EXPORT dom::NodePtr createPhongMaterial(ScenePtr theScene,
                                const std::string & theName,
                                const PhongProperties & thePhongProperties,
                                bool theTransparencyFlag = false,
                                bool theSpriteFlag = false);

Y60_MODELLING_EXPORT dom::NodePtr createPhongTexturedMaterial(ScenePtr theScene,
...
Y60_MODELLING_EXPORT dom::NodePtr createUnlitTexturedColoredMaterial(y60::ScenePtr theScene,
                                 const std::string & theTextureFilename,
                                 const std::string & theName = "UnlitTexturedColored",
                                 bool theSpriteFlag = false,
                                 unsigned theDepth = 1);

Y60_MODELLING_EXPORT dom::NodePtr createUnlitTexturedMaterial(y60::ScenePtr theScene,
                                 const std::string & theTextureFilename,
...
Y60_MODELLING_EXPORT dom::NodePtr createLambertMaterial(y60::ScenePtr theScene,
...
Y60_MODELLING_EXPORT dom::NodePtr createColorMaterial(y60::ScenePtr theScene,
                                 const asl::Vector4f & theColor = asl::Vector4f(1,1,1,1),
                                 const std::string & theName = "Color",
                                 bool theTransparencyFlag = false);

Y60_MODELLING_EXPORT dom::NodePtr createTransform(dom::NodePtr theParentNode,
                             const std::string & theTransformName = "Transform");
                             
Y60_MODELLING_EXPORT dom::NodePtr createBody(dom::NodePtr theParentNode, const std::string & theShapeId);

/// Set node alpha value. Node can be a body or a shape.
Y60_MODELLING_EXPORT bool setAlpha(dom::Node * theNode, float theAlpha);
Y60_MODELLING_EXPORT bool setAlphaByChangingMaterialColor(dom::NodePtr theMaterial, float theAlpha);
 ...
 */
Y60_MODELLING_EXPORT dom::NodePtr createCanvas(y60::ScenePtr theScene, const std::string & theCanvasId);
Y60_MODELLING_EXPORT dom::NodePtr createQuad(y60::ScenePtr theScene, const std::string & theMaterialId,
                        asl::Vector3f theTopLeftCorner, asl::Vector3f theBottomRightCorner);

Y60_MODELLING_EXPORT dom::NodePtr createPlane(ScenePtr theScene, const std::string & theMaterialId,
        asl::Vector3f theTopLeftCorner, asl::Vector3f theBottomRightCorner,
        int theHSubdivision, int theVSubdivision);

Y60_MODELLING_EXPORT dom::NodePtr
...
Y60_MODELLING_EXPORT dom::NodePtr createCrosshair(y60::ScenePtr theScene, const std::string & theMaterialId,
...
Y60_MODELLING_EXPORT dom::NodePtr createQuadStack(y60::ScenePtr theScene, const asl::Vector3i & theDimensions,
...
Y60_MODELLING_EXPORT dom::NodePtr createVoxelProxyGeometry(y60::ScenePtr theScene, const asl::Box3f & theVoxelBox,
...
Y60_MODELLING_EXPORT dom::NodePtr createSurface2DFromContour(y60::ScenePtr theScene, const std::string & theMaterialId,
...
Y60_MODELLING_EXPORT void smoothNormals(dom::NodePtr theShape);
/// \@}
}
