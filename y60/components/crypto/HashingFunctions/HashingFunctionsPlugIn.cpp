...
namespace y60 {
    class HashingFunctionsPlugIn : public asl::PlugInBase, public jslib::IScriptablePlugin {
        public:
            HashingFunctionsPlugIn(asl::DLHandle theDLHandle) : asl::PlugInBase(theDLHandle) {}
            ...
            const char * ClassName() {
                static const char * myClassName = "HashingFunctions";
                return myClassName;
            }
    };
}
...
extern "C"
EXPORT asl::PlugInBase * HashingFunctions_instantiatePlugIn(asl::DLHandle myDLHandle) {
    return new y60::HashingFunctionsPlugIn(myDLHandle);
}
