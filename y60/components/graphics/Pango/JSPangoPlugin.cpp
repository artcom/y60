...
namespace y60 {
    ...
    class JSPangoPlugin : public asl::PlugInBase, public jslib::IScriptablePlugin {
        public:
            enum PropertyNumbers {
                PROP_END
            };
            JSPangoPlugin(asl::DLHandle theDLHandle) : asl::PlugInBase(theDLHandle) {}
            ...
            const char * ClassName() {
                static const char * myClassName = "Pango";
                return myClassName;
            }
    };
}
...
extern "C"
EXPORT asl::PlugInBase * Pango_instantiatePlugIn(asl::DLHandle myDLHandle) {
    return new y60::JSPangoPlugin(myDLHandle);
}
