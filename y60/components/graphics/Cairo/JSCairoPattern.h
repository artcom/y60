...
namespace jslib {
    ...
    namespace cairo {
        class JSPattern : public JSWrapper<JSCairoPatternWrapper, asl::Ptr< JSCairoPatternWrapper >, StaticAccessProtocol> {
            JSPattern();  // hide default constructor
            public:
            ...
            JSPattern(OWNERPTR theOwner, NATIVE * theNative)
            ...
            static JSPattern & getObject(::JSContext *cx, JSObject * obj) {
                return dynamic_cast<JSPattern &>(JSPattern::getJSWrapper(cx,obj));
            }
    ...
    template <>
    struct JSClassTraits<cairo::JSPattern::NATIVE>
        : public JSClassTraitsWrapper<cairo::JSPattern::NATIVE, cairo::JSPattern> {};

    jsval as_jsval(JSContext *cx, cairo::JSPattern::OWNERPTR theOwner, cairo::JSPattern::NATIVE * thePattern);
    jsval as_jsval(JSContext *cx, cairo::JSPattern::OWNERPTR theOwner, cairo_pattern_t * thePattern);
