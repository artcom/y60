...
Y60_JSLIB_DECL bool convertFrom(JSContext *cx, jsval theValue, JSPerlinNoise::NATIVE & thePerlinNoise);

Y60_JSLIB_DECL jsval as_jsval(JSContext *cx, JSPerlinNoise::OWNERPTR theOwner);
Y60_JSLIB_DECL jsval as_jsval(JSContext *cx, JSPerlinNoise::OWNERPTR theOwner, JSPerlinNoise::NATIVE * thePerlinNoise);
